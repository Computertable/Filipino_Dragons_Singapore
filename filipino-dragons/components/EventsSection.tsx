      ...
      >
        {RACE_DATA.map((race) => (
          <motion.div
            ...
            className="relative flex-shrink-0 w-[85vw] md:w-[400px] aspect-[4/5] bg-neutral-900 rounded-[2.5rem] overflow-hidden cursor-pointer snap-center group"
          >
            <img 
              src={race.coverImage} 
              alt={race.title}
            ...
            <div className="relative h-full p-8 flex flex-col justify-between text-white">
              <div>
                <p className="font-montserrat text-xs font-medium font-black uppercase tracking-[0.2em] mb-2 text-white/70">
                  {race.subtitle}
                </p>
